...
// Create an App Service Plan with Flex Consumption
...
output MCP_ENDPOINT string = 'https://${api.outputs.SERVICE_API_NAME}.azurewebsites.net/runtime/webhooks/mcp/sse'
